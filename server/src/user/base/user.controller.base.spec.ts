...
const CREATE_INPUT = {
  ...
  disabilityId: "exampleDisabilityId",
  firstName: "exampleFirstName",
  grade: "exampleGrade",
  id: "exampleId",
  lastName: "exampleLastName",
  parentguardian: "exampleParentguardian",
  password: "examplePassword",
  psychologist: "examplePsychologist",
  roles: ["exampleRoles"],
  school: "exampleSchool",
  studentAddress: "exampleStudentAddress",
  studentEmail: "exampleStudentEmail",
  studentId: "exampleStudentId",
  teacherOfRecord: "exampleTeacherOfRecord",
  updatedAt: new Date(),
